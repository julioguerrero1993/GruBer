        ...
        <div class="c-hero">
          <div class="c-quotient">
            <div class="c-quotient__inner">
              <h1 class="c-quotient__title"><strong>Buscar</strong><br> Grúa</h1>
              <p class="c-quotient__subtitle">Obtén tu grúa en línea</p>
              <form class="o-form o-form--quotient" action="">
                <div class="o-form__field o-form__field--select">
                  <label class="o-form__label">Vehículo</label>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="o-box u-mb40 u-text-center">
                  <h2 class="o-title o-title--secundary">¿Qué quieres llevar en tu Grúa?</h2>
                  <h5 class="o-title o-title--epigraph">Selecciona un producto para más información</h5>
                  <ul class="o-list o-list--products row">
                    <li class="o-list__item col-md-4 col-sm-6"><a class="o-list__link" href="#"><i class="o-list__icon mx-car"></i><span class="o-list__title">VEHÍCULO</span></a></li>
